...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/cloud-provider-payment/src/main/java");
        // XML ResultMap
...
//        gc.setSwagger2(true);
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/payment?useUnicode=true&characterEncoding=utf8&serverTimezone=UTC&useSSL=true");
...
//        strategy.setTablePrefix("t_");
        ...
        //设置继承基类
        strategy.setSuperEntityClass("com.zzz.springcloud.com.zzz.springcloud.mybatis.common.BaseEntity");
        //字段注释
        ...
        pc.setParent("com.zzz.springcloud");
